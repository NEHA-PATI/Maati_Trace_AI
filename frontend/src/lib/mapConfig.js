export const MAP_CONFIG = {
  ...
  zoom: {
    ...
    farm: Number(import.meta.env.VITE_MAP_FARM_ZOOM || 24),
    minimumDrawing: Number(import.meta.env.VITE_MAP_MIN_DRAW_ZOOM || 17),
    maximum: Number(import.meta.env.VITE_MAP_MAX_ZOOM || 24),
    nativeImagery: Number(import.meta.env.VITE_MAP_NATIVE_ZOOM || 23),
  },
